        ...
        <Link href={"/product/" + props.slug} className="rounded-[16px] p-[12px] border border-[#EDEDED]">
            <Slide duration={200} direction="up" triggerOnce>
                ...
                <div className="mt-[12px] flex items-center justify-between">
                    <p className="text-[12px] text-[#3D3D3D] font-semibold h-4 
                        overflow-hidden">{props.title}</p>
                    <div className="size-[20px]">
                        <HeartIcon />
                    </div>
                </div>
                <p className="text-[10px] text-[#3D3D3D] mt-[12px] h-4 overflow-hidden font-regular text-justify">
                    {props.summary}
                </p>
